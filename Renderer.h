...
public:
    ...
    void stopGame() { isGameStarted = false; }
...
private:
    ...
    TextureHandle mTextureHandle[7]; // can make into an array to hold multiple texture assets
    ...
    int mFrameCounter = 0;
    std::vector<QVector3D> fluidVelocities;
};
